...
| Editing  	| [indentLine](https://github.com/Yggdroot/indentLine) <br /> [vim-illuminate](https://github.com/RRethy/vim-illuminate) 	| \*Display thin vertical lines at each indentation level <br /> \*Automatically highlight other uses of the current word under the cursor
